            ...
            <div class="col-xs-12 ">
                ...
                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <!--login--->
                        <form method="post" action="Controllers/login.php" class="form-horizontal" id="loginDiv">
                            <div class="logo">
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="container">
                            <form class="form-horizontal" role="form" method="POST" action="Controllers/signUp.php" id="signupDiv">
                                <div class="row">
